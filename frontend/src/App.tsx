...
import { TopicGeneratorPage } from "./presentation/pages/TopicGenerator";
  ...
  return (
    <>
      <aside className="sidebar">
        ...
        <div className="sidebar-footer">HK01 AI Editor v1.0</div>
      </aside>
